...
export default function OfferCard({ title, content }: OfferCardProps) {
  return (
    <motion.div
      ...
      className="min-w-[60vw] lg:min-w-0 w-3/4 sm:w-1/2 lg:w-1/4 flex flex-col lg:flex-auto gap-[12px] px-[15px] py-[20px] border border-[#0043FE80] bg-[#1B1B1B] rounded-[15px]"
    >
      <CodeIcon />
